...
console.log("Title case", perName.charAt(0).toUpperCase() + perName.slice(1).toLowerCase());
//Day 2 Challenge;
//Question 1
...
console.log("Inequality test with numbers:", 49 !== 26);
...
console.log("Is burger is in my favourite food:", favouriteFood.includes("burger"));
// Test whether an item is not in a array
console.log("Is fish is in my favourite food:", !favouriteFood.includes("fish"));
//Days 9 Challenge
//Question 25
...
if (alienColor == "green") {
    console.log("wow what a shot You have earned 5 points for shooting the alien !");
}
else {
...
if (alien_Color1 == "green") {
    ...
    console.log("wow what a shot You have earned 10 points for shooting the alien !");
}
else if (alien_Color1 == "yellow") {
    console.log("wow what a shot You have earned 15 points for shooting the alien !");
}
//Alien color: yellow
...
newUser.forEach(newUsername => {
    ...
    if (currentUser.map(curr_user => curr_user.toLowerCase()).includes(lowerCase)) {
...
//Day 12 challenge
//Question 34
let favouritePizza = ['Tikka pizza', 'chicken Lava pizza', 'muglai pizza'];
for (let pizza of favouritePizza) {
    console.log(` I like ${pizza}.`);
}
console.log(" I really love pizza.");
//question 35
let animalschar = ['fish', 'shark', 'dolphine'];
...
console.log(album3);
//Question 41
let magician = ['Harry potter', 'Raven', 'Wizard Delamorte', 'Criss Angel', 'David Copperfield'];
//Question 43
...
//Question 45
function carDetail(manufacture, model, ...moreOptions) {
    let details = Object.assign({ manufacture,
        model }, Object.assign({}, ...moreOptions));
    return details;
}
;
let information = carDetail("honda", "civic", { color: "black" }, { "year": 2020 });
